  ...
  chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    ...
    if (message[0] == 'BET' && round.rounds == 0) {
      ...
      if(round.rounds > 0){
        ...
        console.log(['RESULT', betStats[round.rounds - 1].thread,(record[4] == 'x1.01')? 'win' : 'lost' , record])
        chrome.runtime.sendMessage(['RESULT', betStats[round.rounds +1].thread,(record[4] == 'x1.01')? 'win' : 'lost' , record], (response) => {})
      }
      ...
      if (round.rounds == 2) {
        ...
        console.log(['RESULT', 'thread_3',(record[4] == 'x1.01')? 'win' : 'lost' , record])

        chrome.runtime.sendMessage(['RESULT', 'thread_3',(record[4] == 'x1.01')? 'win' : 'lost' , record], (response) => {})
